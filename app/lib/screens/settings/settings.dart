...
class _SettingsScreenState extends State<SettingsScreen> {
    ...
    showDialog<void>(
      ...
      builder: (BuildContext context) {
        return TurtleScheduleDialog(
          ...
          onSave: (begin, end, day) => _updateSession(SessionBase(
    ...
    showDialog<void>(
      ...
      builder: (BuildContext context) {
        return NumberInputDialog(
          ...
          onSave: (value) => _updateSession(SessionBase(
              idleSeedingLimit: value, idleSeedingLimitEnabled: true)),
        );
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<AppModel, SessionModel>(
      ...
      final blocklistEnabled = sessionModel.session?.blocklistEnabled ?? false;
      ...
      final seedRatioLimited = sessionModel.session?.seedRatioLimited ?? false;
            ...
            child: ListView(children: [
              ...
              Consumer<TorrentsModel>(
                builder: (context, torrentsModel, _) => SwitchListTile(
                  ...
                  subtitle:
                      Text(localizations.stopSeedingWhenCompleteDescription),
                  value: torrentsModel.stopSeedingWhenComplete,
                  onChanged: (v) => torrentsModel.setStopSeedingWhenComplete(v),
                ),
              ),
              ListTile(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 16.0, top: 16),
                child: Text(localizations.privacyAndSecurity,
                    style: Theme.of(context).textTheme.titleLarge),
              ),
              ListTile(
                ...
                title: Text(localizations.encryption),
                subtitle: Text(_encryptionLabel(localizations, encryptionMode)),
              ),
              SwitchListTile(
                secondary: const Icon(Icons.block),
                title: Text(localizations.blocklist),
                subtitle: Text(blocklistEnabled && blocklistSize > 0
              ...
              ListTile(
                ...
                subtitle: Text(blocklistUrl.isEmpty
              ...
              Padding(
                padding: const EdgeInsets.only(left: 16.0, top: 16),
                child: Text(localizations.schedulingAndLimits,
                    style: Theme.of(context).textTheme.titleLarge),
              ),
              SwitchListTile(
              ...
              ListTile(
                  ...
                  subtitle: Text(seedRatioLimit > 0
              ...
              ListTile(
                  ...
                  subtitle: Text(idleSeedingLimit > 0
